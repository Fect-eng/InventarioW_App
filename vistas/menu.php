    ...
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="../userApp.php">Usuarios App</a></li>

              <li><a href="clientes.php">Clientes Empresa</a></li>
              <li><a href="clientesNaturales.php">Clientes Naturales</a></li>
            </ul>
          </li>
        ...
        if($_SESSION['usuario']=="admin"):
         ?>
           <li><a href="usuarios.php"><span class="glyphicon glyphicon-user"></span> Administrar Sistema</a>
            </li>
         <?php 
       endif;
          ?>
