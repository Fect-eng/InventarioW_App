...
<?php 
//session_start();
require_once "dependenciasApp.php"; 
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-list-alt"></span> Administrar Sistema <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="categorias.php">Categorias</a></li>
              <li><a href="../vistas/articulos.php">Articulos</a></li>
              <li><a href="../web_services/usuario_agregarapp.php">Usuarios App</a></li>
            </ul>
          </li>
        ...
        if($_SESSION['usuario']=="admin"):
         ?>
           <li><a href="../vistas/usuarios.php"><span class="glyphicon glyphicon-user"></span> Administrar Sistema</a>
            </li>
         <?php 
       endif;
          ?>
          ...
          <li><a href="ventas.php"><span class="glyphicon glyphicon-fire"></span> Vender Articulo</a>
          </li>
          ...
          <li class="dropdown" >
            ...
            <ul class="dropdown-menu">
              <li> <a style="color: red" href="#"><span class="glyphicon glyphicon-off"></span> Salir</a></li>
